...
- [x] **Step 1: Add failing detail and metadata tests**
...
- [x] **Step 3: Implement the detail and hover changes**
...
- [x] **Step 1: Add a failing responsive layout test**
...
- [x] **Step 3: Add the narrow layout hook and classes**
...
- [x] **Step 3: Implement centralized expiry handling**
...
- [x] **Step 3: Implement the contract and prompt**
...
- [x] **Step 1: Add a failing categorize test**
...
- [x] **Step 3: Mark this plan complete and inspect the patch**
