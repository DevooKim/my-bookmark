...
- `supabase/migrations/<timestamp>_bookmark_metadata.sql`: add JSONB storage; the existing `SETOF public.bookmarks` search function inherits the new column without recreation.
...
- [x] **Step 3: Implement the normalized record schema**
...
- [x] **Step 4: Create and fill the migration**
...
Confirm the current image-aware `search_bookmarks` returns `SETOF public.bookmarks`. Because that row type automatically includes added table columns, do not recreate the function in this migration.

- [x] **Step 5: Run shared tests and migration checks GREEN**
...
- [x] **Step 1: Write failing AI parser tests**
...
- [x] **Step 4: Write failing categorize service tests**
...
- [x] **Step 5: Implement the confidence gate and merge**
...
- [x] **Step 6: Run AI and API service tests GREEN**
...
- [x] **Step 1: Write failing mapper/route tests**
...
- [x] **Step 3: Implement DB/API mapping**
...
- [x] **Step 2: Run UI rendering tests RED**
...
- [x] **Step 4: Integrate cards and detail**
...
- [x] **Step 5: Write failing editor tests**
...
- [x] **Step 6: Implement `BookmarkMetadataEditor`**
...
- [x] **Step 7: Run all targeted web tests GREEN**
...
- [x] **Step 4: Reanalyze the two existing restaurant images**
