...
- [ ] **Step 1: Write failing source-link policy tests**
...
- [ ] **Step 1: Add failing categorize integration tests**
...
- [ ] **Step 3: Implement sequential safe metadata merging**
...
- [ ] **Step 1: Add explicit web dependencies**
...
- [ ] **Step 4: Implement lazy decoding and bounded canvas conversion**
...
- [ ] **Step 1: Add failing `ImageUpload` tests**
...
- [ ] **Step 3: Implement preview and terminal-state lifecycle**
...
- [ ] **Step 3: Implement dialog completion behavior**
